...
Launch the WSL2 Kali desktop from a terminal window.  It will run full screen on the current monitor. Execute _as you_ from a Linux command line to bring up the Linux GUI
